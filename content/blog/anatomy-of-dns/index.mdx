...
There has been significate updates of the DNS protocol throughout the years. Especially with the addition of _DNSSEC_ in January of 1997 through [rfc 2065](https://datatracker.ietf.org/doc/html/rfc2065), and later updated by [rfc 2535](https://datatracker.ietf.org/doc/html/rfc2535). _DNSSEC_ wont be covered in this post as it is a big topic.
...
18:49:49.939297 lo    In  IP 127.0.0.1.38500 > 127.0.0.53.53: 39085+ [1au] A? blog.toerktumlare.com. (62)
	...
	0x0010:  7f00 0035 9664 0035 0046 fe8d 98ad 0100  ...5.d.5.F......
...
So our counters show us that there is one _question_ in our message.

<InfoBox>
ARCount is comomnly set to 1 indicating that there is an _additional record_ included. DNS has pretty much _outgrown_ its header size and there was a need to be able to include more meta information in messages so DNS was extended in [rfc 6891](https://datatracker.ietf.org/doc/html/rfc6891) to include _psuedo records_ that is used to include additional meta information in both requests and responses.
</InfoBox>
...
Nowdays most of these definitions are deprecated so in a standard DNS query this value is always set to 1 to represent _the internet_.
